        ...
        <form @submit.prevent="handleSubmit" class="space-y-8 mt-6">
          <div class="grid md:grid-cols-2 gap-8">
            <div class="space-y-2 group">
              <label for="firstName" class="text-sm font-medium text-dark-600 group-focus-within:text-primary transition-colors">
                First Name
              </label>
              <div class="relative">
                <input 
                  ...
                  required 
                />
                <Icon name="mdi:account" class="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-primary transition-colors"/>
              </div>
            </div>
   
            <div class="space-y-2 group">
              <label for="lastName" class="text-sm font-medium text-dark-600 group-focus-within:text-primary transition-colors">
                Last Name
              </label>
              <div class="relative">
                <input 
          ...
          <div class="space-y-2 group">
            <label for="email" class="text-sm font-medium text-dark-600 group-focus-within:text-primary transition-colors">
              Email Address
            </label>
            <div class="relative">
              <input 
                ...
                required 
              />
              <Icon name="mdi:email" class="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-primary transition-colors"/>
            </div>
          </div>
   
          <div class="space-y-2 group">
            <label for="phone" class="text-sm font-medium text-dark-600 group-focus-within:text-primary transition-colors">
              Phone Number
            </label>
            <div class="relative">
              <input 
                ...
                class="w-full px-6 py-3 rounded-xl border-2 border-gray-100 focus:border-primary focus:ring-4 focus:ring-primary/20 outline-none transition-all bg-white/50"
              />
              <Icon name="mdi:phone" class="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-primary transition-colors"/>
            </div>
          </div>
   
          <div class="space-y-2 group">
            <label for="service" class="text-sm font-medium text-dark-600 group-focus-within:text-primary transition-colors">
              Service Interest
            </label>
            <div class="relative">
              <select 
              ...
              <Icon name="mdi:chevron-down" class="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 pointer-events-none group-focus-within:text-primary transition-colors"/>
            </div>
          </div>
   
          <div class="space-y-2 group">
            <label for="message" class="text-sm font-medium text-dark-600 group-focus-within:text-primary transition-colors">
              Your Message
            </label>
            <div class="relative">
              <textarea 
                ...
                required
              ></textarea>
              <Icon name="mdi:message-text" class="absolute right-4 top-4 w-5 h-5 text-gray-400 group-focus-within:text-primary transition-colors"/>
            </div>
          </div>
