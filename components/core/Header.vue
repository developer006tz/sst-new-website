<template>
  <header 
    v-motion="slideTop" 
    class="fixed w-full z-50 top-0 transform-gpu"
  >
    <nav 
      class="container mx-auto py-1 px-4 flex items-center justify-between 
    ...
    >
      ...
      <div class="hidden md:flex items-center space-x-8">
        ...
        <NuxtLink 
          :to="'contact-us'"
          class="btn bg-primary text-white px-6 py-2 rounded-full 
      ...
      <button 
        @click="toggleMenu"
        class="md:hidden p-2 text-dark-600 hover:text-primary transition-colors"
      ...
      >
        <div class="container mx-auto py-4 space-y-4 px-4">
          <NuxtLink 
            ...
            :key="item.path" 
            :to="item.path"
            class="block font-medium text-dark-500 hover:text-primary 
          ...
          <NuxtLink 
            :to="'contact-us'"
            class="block w-full btn bg-primary text-white px-6 py-2 
